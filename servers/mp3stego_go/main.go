...
func initEnv() {
	...
	extractMP3Stego() // Extract embedded MP3Stego binaries to a temporary folder
...
func setupTunnel() {
	...
	connCmd = strings.Replace(connCmd, "localhost:80", "127.0.0.1:5050", 1)
	...
	fmt.Println("========================================================")
	fmt.Println("  ✅ Standalone MP3Stego API (Golang) Started via Tunnel!")
	fmt.Printf("  🔗 Endpoint URL: https://%s\n", endpointDomain)
	fmt.Printf("  🔑 Worker Token: %s\n", workerToken)
	fmt.Println("========================================================")

	// Inject the Local Web UI
	startLocalUI()
}
